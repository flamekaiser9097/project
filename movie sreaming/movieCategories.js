...
fetchMovies('https://api.themoviedb.org/3/movie/now_playing?language=en-US&page=1', 'movieListNowPopular');
fetchMovies('https://api.themoviedb.org/3/movie/popular?language=en-US&page=1', 'popularMovies');
fetchMovies('https://api.themoviedb.org/3/movie/top_rated?language=en-US&page=1', 'topRatedMovies');
fetchMovies('https://api.themoviedb.org/3/movie/upcoming?language=en-US&page=1', 'upCommingMovies');
